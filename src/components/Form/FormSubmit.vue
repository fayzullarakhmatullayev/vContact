<template>
  <form class="form" @submit.prevent.enter="submitHandler">
    ...
    <div class="form-buttons">
      ...
      <BaseButton type="submit" btn-class="btn-green">{{ isEdit ? 'Edit' : 'Add' }}</BaseButton>
    </div>
  </form>
</template>
...
const submitHandler = () => {
  if (props.isEdit) {
    ...
    store.addContact({ ...props.initialFormValue, id: new Date() })
  }
  emit('closeForm')
}
</script>
